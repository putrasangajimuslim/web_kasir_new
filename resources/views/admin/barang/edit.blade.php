            ...
            <div class="card-body">
                ...
                <form action="{{ route('products.update') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="InputHargaBeli" name="harga_beli" value="{{ $barang->harga_beli }}" min="1">
                        @error('harga_beli')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="InputHargajual" name="harga_jual" value="{{ $barang->harga_jual }}" min="1">
                        @error('harga_jual')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="InputStok" name="stok" value="{{ old('stok', $barang->stok) }}" min="1">
                        @error('stok')
