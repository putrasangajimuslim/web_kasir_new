            ...
            <div class="card-body">
                ...
                <form action="{{ route('products.update') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="InputMargin" name="margin_keuntungan" value="{{ $barang->margin_keuntungan }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="InputHargajual" name="harga_jual" value="{{ $barang->harga_jual }}" readonly>
                        @error('harga_jual')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="InputSatuanbarang" name="satuan_barang" value="{{ old('satuan_barang', $barang->satuan_barang) }}">
                    </div>
